...
using namespace winrt::deviceManagerUI;
using namespace winrt::deviceManagerUI::implementation;
...
App::App() noexcept
{
    ...
    PackageProviders().Append(winrt::deviceManagerUI::ReactPackageProvider());
...
void App::OnLaunched(activation::LaunchActivatedEventArgs const& e)
{
    ...
    rootFrame.Navigate(xaml_typename<deviceManagerUI::MainPage>(), box_value(e.Arguments()));
}
...
void App::OnFileActivated(Windows::ApplicationModel::Activation::IFileActivatedEventArgs const& args)
{
    if (args.Files().Size() == 1) {
        ...
        auto readTextPromise = winrt::Windows::Storage::FileIO::ReadBufferAsync(file.as<winrt::Windows::Storage::StorageFile>());
